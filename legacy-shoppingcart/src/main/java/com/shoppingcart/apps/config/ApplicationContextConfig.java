package com.shoppingcart.apps.config;
...
import com.shoppingcart.apps.impl.AccountDAOImpl;
import com.shoppingcart.apps.impl.OrderDAOImpl;
import com.shoppingcart.apps.impl.ProductDAOImpl;
	...
	public class ApplicationContextConfig {
	    ...
	    public SessionFactory getSessionFactory(DataSource dataSource) throws Exception {
	        ...
	        factoryBean.setPackagesToScan(new String[] { "com.shoppingcart.apps.entity" });
